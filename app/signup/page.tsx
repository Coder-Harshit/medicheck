      ...
      <form className="flex flex-col">
        <div className="pb-2">
          ...
          <div className="relative text-gray-400"><span className="absolute inset-y-0 left-0 flex items-center p-1 pl-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-mail"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg></span>
            <InputBox type="text" name="name" id="name" placeholder="Your Name" autoComplete="off" />
          </div>
        </div>
        <div className="pb-2">
        ...
        <button type="submit" className="w-full text-[#FFFFFF] bg-[#4F46E5] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6" formAction={signup}>Sign Up</button>
        <div className="text-sm font-light text-[#6B7280] text-center">Already have an account? <Link href={'/login'} className="font-medium text-[#4F46E5] hover:underline">Login</Link>
...
{/* </div>
            <form className="flex flex-col">
                ...
                <div className="text-sm font-light text-[#6B7280] text-center">Don't have an accout yet?
